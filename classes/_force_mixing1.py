...
class _force_mixing1(InputSection):
    def __init__(self):
        ...
        self._subsections = {'PRINT': 'PRINT', 'RESTART_INFO': 'RESTART_INFO'}
        self._repeated_subsections = {'QM_NON_ADAPTIVE': '_qm_non_adaptive1', 'BUFFER_LINKS': '_buffer_links1', 'BUFFER_NON_ADAPTIVE': '_buffer_non_adaptive1'}
