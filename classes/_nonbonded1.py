...
class _nonbonded1(InputSection):
    def __init__(self):
        ...
        self._repeated_subsections = {'GENPOT': '_genpot1', 'GOODWIN': '_goodwin1', 'QUIP': '_quip1', 'BMHFT': '_bmhft1', 'SIEPMANN': '_siepmann1', 'BMHFTD': '_bmhftd1', 'LENNARD_JONES': '_lennard_jones1', 'BUCKMORSE': '_buckmorse1', 'TERSOFF': '_tersoff1', 'EAM': '_eam1', 'BUCK4RANGES': '_buck4ranges1', 'IPBV': '_ipbv1', 'WILLIAMS': '_williams1'}
