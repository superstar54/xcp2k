...
class _atom1(InputSection):
    def __init__(self):
        ...
        self._name = "ATOM"
        self._keywords = {'Core': 'CORE', 'Run_type': 'RUN_TYPE', 'Calculate_states': 'CALCULATE_STATES', 'Atomic_number': 'ATOMIC_NUMBER', 'Coulomb_integrals': 'COULOMB_INTEGRALS', 'Exchange_integrals': 'EXCHANGE_INTEGRALS', 'Max_angular_momentum': 'MAX_ANGULAR_MOMENTUM', 'Element': 'ELEMENT'}
        self._repeated_keywords = {'Electron_configuration': 'ELECTRON_CONFIGURATION'}
        self._subsections = {'AE_BASIS': 'AE_BASIS', 'OPTIMIZATION': 'OPTIMIZATION', 'PRINT': 'PRINT', 'PP_BASIS': 'PP_BASIS', 'POWELL': 'POWELL', 'POTENTIAL': 'POTENTIAL'}
