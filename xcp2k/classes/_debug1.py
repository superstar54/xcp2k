...
class _debug1(InputSection):
    def __init__(self):
        ...
        self._name = "DEBUG"
        self._keywords = {'Eps_no_error_check': 'EPS_NO_ERROR_CHECK', 'Stop_on_mismatch': 'STOP_ON_MISMATCH', 'Debug_stress_tensor': 'DEBUG_STRESS_TENSOR', 'Debug_forces': 'DEBUG_FORCES', 'Dx': 'DX'}
