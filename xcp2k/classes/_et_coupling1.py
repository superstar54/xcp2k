...
from xcp2k.classes._becke_constraint_a1 import _becke_constraint_a1
from xcp2k.classes._becke_constraint_b1 import _becke_constraint_b1
...
class _et_coupling1(InputSection):
    def __init__(self):
        ...
        self._subsections = {'BECKE_CONSTRAINT_A': 'BECKE_CONSTRAINT_A', 'BECKE_CONSTRAINT_B': 'BECKE_CONSTRAINT_B', 'PROJECTION': 'PROJECTION', 'PROGRAM_RUN_INFO': 'PROGRAM_RUN_INFO'}
