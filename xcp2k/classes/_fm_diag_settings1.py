...
class _fm_diag_settings1(InputSection):
    def __init__(self):
        ...
        self._keywords = {'Parameter_a': 'PARAMETER_A', 'Parameter_x': 'PARAMETER_X', 'Elpa_force_redistribute': 'ELPA_FORCE_REDISTRIBUTE', 'Print_fm_redistribute': 'PRINT_FM_REDISTRIBUTE'}
