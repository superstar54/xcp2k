...
class _mao5(InputSection):
    def __init__(self):
        ...
        self._name = "MAO"
        self._keywords = {'Optimize_scaled_virt_dm': 'OPTIMIZE_SCALED_VIRT_DM', 'Max_iter_occ': 'MAX_ITER_OCC', 'Optimize_scaled_occ_dm': 'OPTIMIZE_SCALED_OCC_DM', 'Eps_grad_virt': 'EPS_GRAD_VIRT', 'Mao_virt': 'MAO_VIRT', 'Eps_grad_occ': 'EPS_GRAD_OCC', 'Mao_occ': 'MAO_OCC', 'Max_iter_virt': 'MAX_ITER_VIRT'}
        self._aliases = {'Opt_sc_dm_virt': 'Optimize_scaled_virt_dm', 'Opt_sc_dm_occ': 'Optimize_scaled_occ_dm'}
