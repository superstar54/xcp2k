...
class _motion1(InputSection):
    def __init__(self):
        ...
        self.PRINT_list = []
        self._name = "MOTION"
        self._subsections = {'MD': 'MD', 'SHELL_OPT': 'SHELL_OPT', 'MC': 'MC', 'CONSTRAINT': 'CONSTRAINT', 'DRIVER': 'DRIVER', 'FLEXIBLE_PARTITIONING': 'FLEXIBLE_PARTITIONING', 'BAND': 'BAND', 'GEO_OPT': 'GEO_OPT', 'TMC': 'TMC', 'CELL_OPT': 'CELL_OPT', 'FREE_ENERGY': 'FREE_ENERGY', 'PINT': 'PINT'}
