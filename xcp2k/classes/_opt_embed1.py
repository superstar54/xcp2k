...
class _opt_embed1(InputSection):
    def __init__(self):
        ...
        self._keywords = {'N_iter': 'N_ITER', 'Dens_conv_max': 'DENS_CONV_MAX', 'Read_embed_pot': 'READ_EMBED_POT', 'Level_shift': 'LEVEL_SHIFT', 'Embed_restart_file_name': 'EMBED_RESTART_FILE_NAME', 'Dens_conv_int': 'DENS_CONV_INT', 'Add_const_pot': 'ADD_CONST_POT', 'Trust_rad': 'TRUST_RAD', 'Reg_lambda': 'REG_LAMBDA'}
