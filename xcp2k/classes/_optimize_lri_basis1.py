...
class _optimize_lri_basis1(InputSection):
    def __init__(self):
        ...
        self._keywords = {'Condition_weight': 'CONDITION_WEIGHT', 'Max_fun': 'MAX_FUN', 'Use_condition_number': 'USE_CONDITION_NUMBER', 'Geometric_sequence': 'GEOMETRIC_SEQUENCE', 'Degrees_of_freedom': 'DEGREES_OF_FREEDOM', 'Step_size': 'STEP_SIZE', 'Accuracy': 'ACCURACY'}
