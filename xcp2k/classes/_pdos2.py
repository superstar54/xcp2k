...
class _pdos2(InputSection):
    def __init__(self):
        ...
        self.R_LDOS_list = []
        self._name = "PDOS"
        self._keywords = {'Nlumo': 'NLUMO', 'Log_print_key': 'LOG_PRINT_KEY', 'Common_iteration_levels': 'COMMON_ITERATION_LEVELS', 'Filename': 'FILENAME', 'Add_last': 'ADD_LAST', 'Components': 'COMPONENTS', 'Out_each_mo': 'OUT_EACH_MO', 'Append': 'APPEND'}
