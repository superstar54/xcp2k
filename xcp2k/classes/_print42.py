...
class _print42(InputSection):
    def __init__(self):
        ...
        self.SCCS = _sccs1()
        self._name = "PRINT"
        self._subsections = {'PROGRAM_BANNER': 'PROGRAM_BANNER', 'BASIS_SET_FILE': 'BASIS_SET_FILE', 'KINETIC_ENERGY': 'KINETIC_ENERGY', 'DERIVATIVES': 'DERIVATIVES', 'NEIGHBOR_LISTS': 'NEIGHBOR_LISTS', 'SUBCELL': 'SUBCELL', 'AO_MATRICES': 'AO_MATRICES', 'MO': 'MO', 'MO_CUBES': 'MO_CUBES', 'STM': 'STM', 'WFN_MIX': 'WFN_MIX', 'ACTIVE_SPACE': 'ACTIVE_SPACE', 'GAPW': 'GAPW', 'DFT_CONTROL_PARAMETERS': 'DFT_CONTROL_PARAMETERS', 'KPOINTS': 'KPOINTS', 'BAND_STRUCTURE': 'BAND_STRUCTURE', 'OVERLAP_CONDITION': 'OVERLAP_CONDITION', 'E_DENSITY_CUBE': 'E_DENSITY_CUBE', 'TOT_DENSITY_CUBE': 'TOT_DENSITY_CUBE', 'V_HARTREE_CUBE': 'V_HARTREE_CUBE', 'EXTERNAL_POTENTIAL_CUBE': 'EXTERNAL_POTENTIAL_CUBE', 'IMPLICIT_PSOLVER': 'IMPLICIT_PSOLVER', 'V_XC_CUBE': 'V_XC_CUBE', 'EFIELD_CUBE': 'EFIELD_CUBE', 'ELF_CUBE': 'ELF_CUBE', 'PDOS': 'PDOS', 'WANNIER90': 'WANNIER90', 'MOMENTS': 'MOMENTS', 'MULLIKEN': 'MULLIKEN', 'LOWDIN': 'LOWDIN', 'HIRSHFELD': 'HIRSHFELD', 'MAO_ANALYSIS': 'MAO_ANALYSIS', 'MINBAS_ANALYSIS': 'MINBAS_ANALYSIS', 'ENERGY_WINDOWS': 'ENERGY_WINDOWS', 'KS_CSR_WRITE': 'KS_CSR_WRITE', 'S_CSR_WRITE': 'S_CSR_WRITE', 'ADJMAT_WRITE': 'ADJMAT_WRITE', 'XRAY_DIFFRACTION_SPECTRUM': 'XRAY_DIFFRACTION_SPECTRUM', 'ELECTRIC_FIELD_GRADIENT': 'ELECTRIC_FIELD_GRADIENT', 'BASIS_MOLOPT_QUANTITIES': 'BASIS_MOLOPT_QUANTITIES', 'HYPERFINE_COUPLING_TENSOR': 'HYPERFINE_COUPLING_TENSOR', 'OPTIMIZE_LRI_BASIS': 'OPTIMIZE_LRI_BASIS', 'PLUS_U': 'PLUS_U', 'SCCS': 'SCCS'}
