...
class _print42(InputSection):
    def __init__(self):
        ...
        self.SCCS = _sccs1()
        self._name = "PRINT"
        self._subsections = {'DERIVATIVES': 'DERIVATIVES', 'WANNIER90': 'WANNIER90', 'KPOINTS': 'KPOINTS', 'AO_MATRICES': 'AO_MATRICES', 'MAO_ANALYSIS': 'MAO_ANALYSIS', 'WFN_MIX': 'WFN_MIX', 'TOT_DENSITY_CUBE': 'TOT_DENSITY_CUBE', 'OVERLAP_CONDITION': 'OVERLAP_CONDITION', 'LOWDIN': 'LOWDIN', 'BAND_STRUCTURE': 'BAND_STRUCTURE', 'XRAY_DIFFRACTION_SPECTRUM': 'XRAY_DIFFRACTION_SPECTRUM', 'ACTIVE_SPACE': 'ACTIVE_SPACE', 'ENERGY_WINDOWS': 'ENERGY_WINDOWS', 'EXTERNAL_POTENTIAL_CUBE': 'EXTERNAL_POTENTIAL_CUBE', 'SCCS': 'SCCS', 'V_XC_CUBE': 'V_XC_CUBE', 'DFT_CONTROL_PARAMETERS': 'DFT_CONTROL_PARAMETERS', 'BASIS_SET_FILE': 'BASIS_SET_FILE', 'ELECTRIC_FIELD_GRADIENT': 'ELECTRIC_FIELD_GRADIENT', 'EFIELD_CUBE': 'EFIELD_CUBE', 'V_HARTREE_CUBE': 'V_HARTREE_CUBE', 'SUBCELL': 'SUBCELL', 'STM': 'STM', 'MO_CUBES': 'MO_CUBES', 'HIRSHFELD': 'HIRSHFELD', 'S_CSR_WRITE': 'S_CSR_WRITE', 'MINBAS_ANALYSIS': 'MINBAS_ANALYSIS', 'GAPW': 'GAPW', 'KINETIC_ENERGY': 'KINETIC_ENERGY', 'IMPLICIT_PSOLVER': 'IMPLICIT_PSOLVER', 'MULLIKEN': 'MULLIKEN', 'HYPERFINE_COUPLING_TENSOR': 'HYPERFINE_COUPLING_TENSOR', 'PROGRAM_BANNER': 'PROGRAM_BANNER', 'MOMENTS': 'MOMENTS', 'MO': 'MO', 'OPTIMIZE_LRI_BASIS': 'OPTIMIZE_LRI_BASIS', 'PDOS': 'PDOS', 'ADJMAT_WRITE': 'ADJMAT_WRITE', 'BASIS_MOLOPT_QUANTITIES': 'BASIS_MOLOPT_QUANTITIES', 'KS_CSR_WRITE': 'KS_CSR_WRITE', 'E_DENSITY_CUBE': 'E_DENSITY_CUBE', 'ELF_CUBE': 'ELF_CUBE', 'NEIGHBOR_LISTS': 'NEIGHBOR_LISTS', 'PLUS_U': 'PLUS_U'}
