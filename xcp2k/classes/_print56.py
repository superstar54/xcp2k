...
class _print56(InputSection):
    def __init__(self):
        ...
        self._name = "PRINT"
        self._subsections = {'V_RESP_CUBE': 'V_RESP_CUBE', 'PROGRAM_RUN_INFO': 'PROGRAM_RUN_INFO', 'RESP_CHARGES_TO_FILE': 'RESP_CHARGES_TO_FILE', 'COORD_FIT_POINTS': 'COORD_FIT_POINTS'}
