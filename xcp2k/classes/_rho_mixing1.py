...
class _rho_mixing1(InputSection):
    def __init__(self):
        ...
        self._keywords = {'Regularization': 'REGULARIZATION', 'Max_step': 'MAX_STEP', 'R_factor': 'R_FACTOR', 'Pulay_beta': 'PULAY_BETA', 'Broy_w0': 'BROY_W0', 'Max_gvec_exp': 'MAX_GVEC_EXP', 'Nbuffer': 'NBUFFER', 'Broy_wref': 'BROY_WREF', 'Nskip': 'NSKIP', 'Beta': 'BETA', 'Pulay_alpha': 'PULAY_ALPHA', 'N_simple_mix': 'N_SIMPLE_MIX', 'Broy_wmax': 'BROY_WMAX', 'Alpha': 'ALPHA', 'Nmixing': 'NMIXING', 'Method': 'METHOD'}
