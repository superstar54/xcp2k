...
calc_diag = CP2K()
#===============================================================================
CP2K_INPUT_Diag = calc_diag.CP2K_INPUT  # This is the root of the input tree
GLOBAL = CP2K_INPUT_Diag.GLOBAL
MOTION = CP2K_INPUT_Diag.MOTION
FORCE_EVAL = CP2K_INPUT_Diag.FORCE_EVAL_add()
SUBSYS = FORCE_EVAL.SUBSYS
DFT = FORCE_EVAL.DFT
SCF = DFT.SCF
#===============================================================================
