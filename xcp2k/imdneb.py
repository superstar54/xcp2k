...
class NEB:
    def __init__(self, images, k=0.1, kp = 1.5, climb=False, parallel=False,
        ...
        self.r0 = self.ntmax/(self.nimages-1)
    ...
    def get_forces(self):
        ...
        for i in range(1, self.nimages - 1):
            ...
            if i == imax and self.climb:
                ...
                # print(f)
                df = 0
                df += t1*self.k[i - 1]*(self.r0 - nt1)
                df -= t2*self.k[i    ]*(self.r0 - nt2)
                # print(self.r0, nt1, nt2, df)
                f += df
                # print(f)
            t1 = t2
            nt1 = nt2
    ...
    def get_potential_energy(self, force_consistent=False):
        ...
        for i in range(0, self.nimages - 1):
            ...
            benergies[i] += 1/2.0*self.k[i - 1]*(self.r0 - nt1)**2
        #
